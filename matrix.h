...
// ======================= Matrix for arithmetic types (SFINAE) =======================
...
public:
    using typename base_matrix<T>::value_type;
    using typename base_matrix<T>::size_type;
    using typename base_matrix<T>::reference;
    using typename base_matrix<T>::const_reference;
...
public:
    ...
    value_type operator()(const size_type row, const size_type col) const { return buffer[row][col]; }
    reference at(const size_type row, const size_type col) { return buffer.at(row).at(col); }
    value_type at(const size_type row, const size_type col) const { return buffer.at(row).at(col); }
